...
mod tests {
    ...
    fn test_namepath() {
        ...
        const EXPECTED_MODULE_FULL_PATH: &'static str = "srctrait-common-testing/integration/namepaths/name-path/one/two";
        const EXPECTED_MODULE_PATH: &'static str = "integration/namepaths/name-path/one/two";
        const EXPECTED_MODULE_NAME: &'static str = "two";
        const EXPECTED_MODULE_RAW: &'static str = "module;integration;srctrait-common-testing;namepaths::name_path::one::two::tests";

        const EXPECTED_GROUP_KIND: testing::TestingKind = testing::TestingKind::Group;
        const EXPECTED_GROUP_FULL_PATH: &'static str = "srctrait-common-testing/integration/namepath-group/uno/dos";
        const EXPECTED_GROUP_PATH: &'static str = "integration/namepath-group/uno/dos";
        const EXPECTED_GROUP_NAME: &'static str = "dos";
        const EXPECTED_GROUP_RAW: &'static str = "group;integration;srctrait-common-testing;namepath-group/uno/dos";

        const EXPECTED_TEST_KIND: testing::TestingKind = testing::TestingKind::Test;
        const EXPECTED_TEST_FULL_PATH: &'static str = "srctrait-common-testing/integration/namepaths/name-path/one/two/test-namepath";
        ...
        const EXPECTED_TEST_RAW: &'static str = "test;integration;srctrait-common-testing;namepaths::name_path::one::two::tests;test_namepath";
