use asmov_common_traitenum_test_exporter_derive as exporter_derive;
use asmov_common_traitenum_test_exporter::SimpleTrait;
use asmov_common_traitenum_test_exporter::ParentTrait;
use asmov_common_traitenum_test_exporter::ChildTrait;
use asmov_common_traitenum_test_exporter::EnumTrait;
...
#[cfg(test)]
mod tests {
    use asmov_common_traitenum_test_exporter::{SimpleTrait,ChildTrait,ParentTrait};
